...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        self.args.processed_user2items_tgt = pickle.load(open(os.path.join(user_proportions_data_path, 'processed_user2items_tgt.pkl'), 'rb'))
        self.args.processed_user2items_src = pickle.load(open(os.path.join(user_proportions_data_path, 'processed_user2items_src.pkl'), 'rb'))
        ...
        self.args.processed_user2aspects_tgt = pickle.load(open(os.path.join(user_proportions_data_path, 'processed_user2aspects_tgt.pkl'), 'rb'))
        ...
        self.args.processed_user2categories_tgt = pickle.load(open(os.path.join(user_proportions_data_path, 'processed_user2categories_tgt.pkl'), 'rb'))
        self.args.processed_user2brands_tgt = pickle.load(open(os.path.join(user_proportions_data_path, 'processed_user2brand_tgt.pkl'), 'rb'))
        ...
        self.args.processed_item2ratings_tgt = pickle.load(open(os.path.join(user_proportions_data_path, 'processed_item2ratings_tgt.pkl'), 'rb'))
    ...
    def eval(self, model=None, test_loader=None):
        if model is None:
            ...
            test_loader = DataLoader(test_set, batch_size=self.args.batch_size * 5, collate_fn=test_set.collate_fn, shuffle=False)
    ...
    def train(self):
        ...
        optimizer = AdamW(params=model.parameters(), lr=self.args.rate_learning, weight_decay=0.1)
        ...
        test_loader = DataLoader(test_set, batch_size=1000, collate_fn=test_set.collate_fn, shuffle=False)
        best_valid_loss = 1e5
