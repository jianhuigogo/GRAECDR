...
class GRAPECDR(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.loss = nn.HuberLoss(delta=1.5)
    ...
    def feature_rating(self, user2features_tgt, feature_types, item2categories_ids_tgt, item2brands_ids_tgt, item2aspects_ids_tgt, item2aspects_polarity_tgt, item2rating_tgt):
        rating_list = []
        if 'brand' in feature_types:
        ...
        if 'avg' in feature_types:
            rating_list.append(item2rating_tgt.unsqueeze(-1))
    ...
    def compute_rating(self, batch):
        (common_user_id, item, rating,
         ...
         item2categories_ids_tgt, item2brands_ids_tgt, item2aspects_ids_tgt, item2aspects_polarity_tgt, item2rating_tgt) = [i.cuda() for i in batch]
        ...
        pred_rating = self.feature_rating(user2features_tgt, self.args.feature_types, item2categories_ids_tgt, item2brands_ids_tgt, item2aspects_ids_tgt, item2aspects_polarity_tgt, item2rating_tgt)
